                        ...
                        for (Module::global_iterator gi = M.global_begin(), ge = M.global_end();
                            ...
                            i++;
                              ...
                              /*&&gv->getType()->getArrayElementType()->getArrayElementType()->isIntegerTy()*/) {
                                        ...
                                        errs()<< i << &*gv << &*dynGV << initializer <<" GV: "<<*gv<<"\n";
                                        ...
                                        if (cdata) {
                                                ...
                                                cur->var = dynGV;
                                                cur->key = 1;//llvm::cryptoutils->get_uint8_t();
                                                ...
                                                for (unsigned i = 0; i != len; ++i) {
                                                        encr[i] = orig[i]-1;//^cur->key;
                                                }
                                                Constant *NewConst = ConstantDataArray::getString(Ctx, StringRef(encr, len), false);


//                                                Constant *NewConst = ConstantDataArray::getString(Ctx, StringRef(encr, len), false);

                                                // FIXME Second part of the unclean hack.
                                                dynGV->setInitializer(NewConst);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                ...
                                //Value *const_key=builder.getInt8((uint8_t)1);
...
//                                loadElement->setAlignment(1);
                                ...
                                Value *Xor = builder.CreateAdd(loadElement,const_key,"add");
